...
describe('packs', () => {
    ...
    it('floats as new floats', () => {
        ...
        expect(erlpack.pack(51512123841234.31423412341435123412341342).equals(Buffer.from('\x83F\x42\xc7\x6c\xcc\xeb\xed\x69\x28', 'binary'))).toBeTruthy();
    });
    ...
    it('list', () => {
        const expected = Buffer.from('\x83l\x00\x00\x00\x05a\x01m\x00\x00\x00\x03twoF\x40\x08\xcc\xcc\xcc\xcc\xcc\xcdm\x00\x00\x00\x04fourl\x00\x00\x00\x01m\x00\x00\x00\x04fivejj', 'binary');
